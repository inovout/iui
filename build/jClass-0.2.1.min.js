...
Object.extend(Function,{build:function(a,b){if("object"==typeof b)return Function(a,b);b=b.trim();var c=b.indexOf("."),d=b.indexOf("(");if(-1==c||c>d)b="this."+b.substring(0,d)+"?this."+b+":"+b;return Function(a,b)}});$.ajaxSetup({error:function(){alert("\u51fa\u73b0\u5f02\u5e38\uff01\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458\uff01")}});Uri=Class.create({initialize:function(a){this.uri=a;return this},paras:[],add:function(a){this.paras.pash(a)},build:function(){return this.uri}});
