...
Object.extend(Function,{build:function(a,b){b=b.trim();var c=b.indexOf("."),d=b.indexOf("(");if(-1==c||c>d)b="this."+b.substring(0,d)+"?this."+b+":"+b;return Function(a,b)}});var Inovout={HAML:{}};
Inovout.HAML.EventAdapter=Class.create({initialize:function(a,b){this.event=a;this.buildFunction=b=b||Function.wrap;return this},listen:function(a,b){this.buildFunction("sender,args",this.fnExpression).call(this.scope,a,b)},addListener:function(a,b,c){this.fnExpression=a;this.scope=b;this.event.addListener(this.listen,this,c)}});
Inovout.HAML.EncryptInput=Class.create({initialize:function(a){var b=a.attr("name"),c=a.data("encrypt").split("|");a.removeAttr("name");var d=$("<input type='hidden' name="+b+" />");a.append(d);a.change.addListener(function(b,f){var n=a.val(),l=new RSAKey;l.setPublic(c[0],c[1]);d.val(l.encrypt(n))});return this}});$.ajaxSetup({error:function(){alert("\u51fa\u73b0\u5f02\u5e38\uff01\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458\uff01")}});
