...
Inovout.XAML.EncryptInput=Class.create({initialize:function(a){var b=a.attr("name"),c=a.data("encrypt").split("|");a.removeAttr("name");var d=$("<input type='hidden' name="+b+" />");a.append(d);a.change.addListener(function(b,f){var n=a.val(),l=new RSAKey;l.setPublic(c[0],c[1]);d.val(l.encrypt(n))});return this}});$.ajaxSetup({error:function(){alert("\u51fa\u73b0\u5f02\u5e38\uff01\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458\uff01")}});
