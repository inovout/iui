...
function f(b){if(a(b)!==s)throw new TypeError;var c=[],g;for(g in b)l.call(b,g)&&c.push(g);if(x)for(var d=0;g=y[d];d++)l.call(b,g)&&c.push(g);return c}function m(a){return g.call(a)===v}function k(a){return"undefined"===typeof a}var g=Object.prototype.toString,l=Object.prototype.hasOwnProperty,n="Null",h="Undefined",p="Boolean",q="Number",r="String",s="Object",w="[object Boolean]",t="[object Number]",u="[object String]",v="[object Array]",z=window.JSON&&"function"===typeof JSON.stringify&&"0"===JSON.stringify(0)&&
...
var d=Array.prototype.slice,e={argumentNames:function(){var a=this.toString().match(/^[\s\(]*function[^(]*\(([^)]*)\)/)[1].replace(/\/\/.*?[\r\n]|\/\*(?:.|[\r\n])*?\*\//g,"").replace(/\s+/g,"").split(",");return 1!=a.length||a[0]?a:[]},bindAsEventListener:function(b){var c=this,k=d.call(arguments,1);return function(g){g=a([g||window.event],k);return c.apply(b,g)}},curry:function(){if(!arguments.length)return this;var a=this,c=d.call(arguments,0);return function(){var d=b(c,arguments);return a.apply(this,
...
0;if(0===d)return-1;Object.isUndefined(b)?b=d:(b=Number(b),isNaN(b)?b=0:0!==b&&isFinite(b)&&(b=(0<b?1:-1)*Math.floor(Math.abs(b))));for(d=0<=b?Math.min(b,d-1):d-Math.abs(b);0<=d;d--)if(d in c&&c[d]===a)return d;return-1}function e(a){var b=[],c=p.call(arguments,0),d,g=0;c.unshift(this);for(var e=0,l=c.length;e<l;e++)if(d=c[e],!Object.isArray(d)||"callee"in d)b[g++]=d;else for(var h=0,f=d.length;h<f;h++)h in d&&(b[g]=d[h]),g++;b.length=g;return b}function f(a){return function(){if(0===arguments.length)return a.call(this,
Prototype.K);if(void 0===arguments[0]){var b=p.call(arguments,1);b.unshift(Prototype.K);return a.apply(this,b)}return a.apply(this,arguments)}}function m(a,b){if(null==this)throw new TypeError;a=a||Prototype.K;for(var c=Object(this),d=[],g=0,e=0,l=c.length>>>0;e<l;e++)e in c&&(d[g]=a.call(b,c[e],e,c)),g++;d.length=g;return d}function k(a,b){if(null==this||!Object.isFunction(a))throw new TypeError;for(var c=Object(this),d=[],g,e=0,l=c.length>>>0;e<l;e++)e in c&&(g=c[e],a.call(b,g,e,c)&&d.push(g));
...
HttpRequest=Class.create({initialize:function(a,b,c){this.method=a.toLowerCase();this.content=c;this.uri=b;return this},execute:function(){Object.isString(this.uri)||(this.uri=this.uri.build());this.uri=encodeURI(this.uri);var a=this,b=new HttpResponse(this);if(!$.support.cors){"delete"==this.method&&(this.method="get",c("delete"));"put"==this.method&&(this.method="post",c("put"));var c=function(b){-1<a.uri.indexOf("?")?a.uri=a.uri+"&httpmethod="+b:a.uri=a.uri+"?httpmethod="+b}}var d={type:this.method,
headers:{}};this.content?(Object.extend(d.headers,this.content.headers),this.content.read().done(function(){d.data=a.content.result;b.setXHR($.ajax(a.uri,d))})):b.setXHR($.ajax(this.uri,d));return b}});HttpResponse=Class.create({initialize:function(a,b){this.request=a;b&&this.setXHR(b);return this},setXHR:function(a){var b=this;this.xhr=a;this.xhr.done(function(c){b.deferred.resolveWith(a,[c])})},read:function(){this.deferred=$.Deferred();return this.deferred.promise()}});
